Module Module1
    ...
    Sub Main()
        Dim LoanAmount, TotalPrincipalReturn, Interest, LoanInterest, MonthlyInterest, PrincipalReturn, InterestRate, MonthlyPay, PayBalance As Double
        ...
        While Not Double.TryParse(Console.ReadLine(), LoanInterest) OrElse (LoanInterest < 0)
            Console.WriteLine("Incorrect Amount, please input a real figure.")
        End While
        Console.WriteLine()
        ...
        For month = 1 To LoanTerm
            ...
            'PayBalance = PrincipalReturn - PayBalance
        ...
        TotalPrincipalReturn = Interest + TotalPrincipalReturn
        Console.WriteLine()
