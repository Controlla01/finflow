Module Module1
    Dim First_sems, Second_sems, YOUR_CGPA, FIRST_GPA, SECOND_GPA As Double
    ...
    Private Sub First_semsPro()
        Dim TP_totalPoints, TCU_totalCreditUnits, SDT101, MAD102, SDA103, WAD104, NS105, AGD106, RESULT, FIRST_GPA As Double
    ...
    Private Sub Second_semsPro()
        ...
        Dim TP_totalPoints, TCU_totalCreditUnits, DBMS201, UI_UX202, AI204, SQT205, AA206, DEVOP207, RESULT, SECOND_GPA As Double
    ...
    Private Sub FindCGPAPro()
        ...
        Console.WriteLine("YOUR_CGPA = " & YOUR_CGPA.ToString)
