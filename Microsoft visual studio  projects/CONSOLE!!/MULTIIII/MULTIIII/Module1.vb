    ...
    Sub Main()
        ...
        Do
            ...
            While Not Double.TryParse(Console.ReadLine(), operation) Or (operation < 1) Or (operation > 5)
                Console.WriteLine("Invalid number. Don't press nonsense again sir/ma, I don tell u before.. its ur last chance")
                Console.WriteLine("")
            End While
            Console.WriteLine("")
            ...
            Console.WriteLine()
            While Not Integer.TryParse(Console.ReadLine(), condition) Or (condition > 2)
                Console.WriteLine("Invalid number. Don't press nonsense again sir/ma.. its ur last chance")
            End While
